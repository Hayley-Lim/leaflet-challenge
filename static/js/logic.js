...
function createFeatures(earthquakeData) {
    ...
    //onEachFeature function gets called on each feature before adding it to a GeoJSON layer
    //attach a popup to features when they are clicked
    function onEachFeature(feature,layer) {
        layer.bindPopup("<h3>" + feature.properties.place +"</h3><hr><p>" + 
        "Time: " + new Date(feature.properties.time) +"</p><p>" + 
...
function createMap(earthquakes) {
   ...
   legend.onAdd = function (myMap) {
        ...
        div.innerHTML += '<i style="background: blue"></i><span>>5</span><br>';
        div.innerHTML += '<i style="background: darkred"></i><span>>4</span><br>';
        div.innerHTML += '<i style="background: red"></i><span>>3</span><br>';
        div.innerHTML += '<i style="background: orange"></i><span>>2</span><br>';
        div.innerHTML += '<i style="background: limegreen"></i><span>>1</span><br>';
        div.innerHTML += '<i style="background: yellow"></i><span><1</span><br>';
